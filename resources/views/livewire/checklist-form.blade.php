    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <form wire:submit.prevent="submit" class="mt-5 sm:flex sm:items-center">
            <div class="max-w-xs w-full">
                <label for="name" class="sr-only">Checklist name</label>
                <div class="relative rounded-md shadow-sm">
                    <input wire:model="name" id="name" class="form-input block w-full sm:text-sm sm:leading-5" placeholder="Morning Habits">
                </div>
            </div>
